...
let Calls = {
  ...
  tripCreate(dtoIn) {
    let commandUri = Calls.getCommandUri("tripCreate");
    return Calls.call("post", commandUri, dtoIn);
  },

  tripImage(dtoIn) {
    let commandUri = Calls.getCommandUri("tripImage");
    return Calls.call("get", commandUri, dtoIn);
  },

  tripGet(dtoIn) {
    let commandUri = Calls.getCommandUri("tripGet");
    return Calls.call("get", commandUri, dtoIn);
  },

  tripDelete(dtoIn) {
    let commandUri = Calls.getCommandUri("tripDelete");
    return Calls.call("post", commandUri, dtoIn);
  },

  participantList(dtoIn) {
    let commandUri = Calls.getCommandUri("participantList");
    return Calls.call("get", commandUri, dtoIn);
  },

  participantGet(dtoIn) {
    let commandUri = Calls.getCommandUri("participantGet");
    return Calls.call("get", commandUri, dtoIn);
  },

  locationGet(dtoIn) {
    let commandUri = Calls.getCommandUri("locationGet");
    return Calls.call("get", commandUri, dtoIn);
  },

  locationList(dtoIn) {
    let commandUri = Calls.getCommandUri("locationList");
    return Calls.call("get", commandUri, dtoIn);
  },

  tripAddParticipant(dtoIn) {
    let commandUri = Calls.getCommandUri("tripAddParticipant");
    return Calls.call("post", commandUri, dtoIn);
  },

  participantUpdate(dtoIn) {
    let commandUri = Calls.getCommandUri("participantUpdate");
    return Calls.call("post", commandUri, dtoIn);
  },
