const Lsi = {
  appName: {
    cs: "Aplikace uuTripmanager",
    en: "Application uuTripmanager",
  },
  ...
  about: {
    header: {
      cs: "O aplikaci uuTripmanager",
      en: "About application uuTripmanager",
    },
    creatorsHeader: {
      cs: "Tvůrci aplikace",
  ...
  unauthInit: {
    buyYourOwn: {
      cs: "Můžete si koupit vlastní uuTripmanager.",
      en: "You can buy your own uuTripmanager.",
    },
    notAuthorized: {
      cs: "Nemáte právo inicializovat tuto aplikaci uuTripmanager.",
      en: "You don't have rights to initialize this uuTripmanager.",
    },
  },
